	...
	return (
		<li className="lista-tareas__tarea">
            ...
            <div className="lista-tareas__contenedor-botones">
                <FontAwesomeIcon icon={faEdit} className="lista-tareas__texto lista-tareas__icono-accion"/>
                <FontAwesomeIcon icon={faTimes} className="lista-tareas__texto lista-tareas__icono-accion"/>
            </div>   
		</li>
	);
};
